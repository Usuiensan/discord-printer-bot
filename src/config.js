...
export const config = {
  ...
  aiFastTimeoutMs: intEnv('AI_FAST_TIMEOUT_MS', intEnv('AI_CHAT_TIMEOUT_MS', 300000)),
  aiThinkTimeoutMs: intEnv('AI_THINK_TIMEOUT_MS', 1200000),
  aiThinkProgressIntervalMs: intEnv('AI_THINK_PROGRESS_INTERVAL_MS', 2500),
  aiThinkProgressMaxChars: intEnv('AI_THINK_PROGRESS_MAX_CHARS', 800),
